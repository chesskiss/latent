...
if __name__ == '__main__':
    ...
    print(float((ev(hmm, S[0], T0_emissions_test)-base(T0_emissions_train, T0_emissions_test))/(ev(hmm, T0, T0_emissions_test)-base(T0_emissions_train, T0_emissions_test))))
    print(float((ev(hmm, S0[0], T0_emissions_test)-base(T0_emissions_train, T0_emissions_test))/(ev(hmm, T0, T0_emissions_test)-base(T0_emissions_train, T0_emissions_test))))
    print(float((ev(hmm, S00[0], T0_emissions_test)-base(T0_emissions_train, T0_emissions_test))/(ev(hmm, T0, T0_emissions_test)-base(T0_emissions_train, T0_emissions_test))))
